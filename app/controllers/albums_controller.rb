class AlbumsController < ApplicationController
  ...
  # GET /studio/albums/1 (will redirect to edit)
  # GET /studio/albums/1.json
  def show
    respond_to do |format|
  ...
  # GET /studio/albums/new
  # GET /studio/albums/new.json
  def new
    @album = Album.new
  ...
  # GET /studio/albums/1/edit
  def edit
  end # def edit

  # PATCH /studio/albums/1
  # PATCH /studio/albums/1.json
  def update
  ...
  # DELETE /studio/albums/1
  # DELETE /studio/albums/1.json
  def destroy
    @album.destroy
    respond_to do |format|
